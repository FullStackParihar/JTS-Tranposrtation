...
//             if (response.ok) {
//                 alert(`Quote generated successfully! Estimated cost: ₹${data.quote.totalAmount}. Check your email for details.`);
//             } else {
...
//                 <button onClick={handleQuotationRequest} id='delivery' className="mt-6 inline-block bg-[#FFD700] text-[#002B5B] font-semibold px-8 sm:px-6 xs:px-4 py-3 sm:py-2 xs:py-1 rounded-lg hover:bg-[#FFECB3]">
//                     Request a Quote
//                 </button>
//             </section>
