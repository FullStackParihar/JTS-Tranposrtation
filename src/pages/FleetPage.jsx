        ...
        <div className="bg-[#6A1B9A] min-h-screen py-10 px-5">
            ...
            <div className="mt-12 bg-white text-[#6A1B9A] py-10 px-5 rounded-lg">
                ...
                <p className="text-lg text-center mb-6">
                    Stay updated with the status of your transport. Enter your vehicle ID to track your shipment.
                </p>
                <div className="flex justify-center">
                    ...
                    />
                    <button className="bg-[#F57C00] text-white px-6 py-2 rounded-lg shadow-lg">Track</button>
                </div>
            </div>
            ...
            <div className="mt-12 bg-[#6A1B9A] text-white py-8 px-5 rounded-lg">
                ...
                <p className="text-lg text-center">
                    At Jagdamba Transport Services, we ensure timely and safe transportation of bulk milk products.
                    Our fleet is equipped to handle large loads and is maintained to the highest standards. Whether you're
                    a dairy provider or need reliable transport, our fleet is ready to serve your needs.
                </p>
            </div>
        </div>
    );
