    ...
    return (
        <>
            <section className="py-16 bg-[#FFFFFF] text-[#212121]">
                ...
                <div id='delivery' className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto px-6">
                    ...
                    <div id='delivery' className="p-6 bg-[#F57C00] rounded-lg shadow-lg text-white">
                ...
                <div className="mt-12 grid gap-8 md:grid-cols-3 max-w-6xl mx-auto px-6">
                    <div id='delivery' className="p-6 border border-[#6A1B9A] rounded-lg shadow-lg">
                ...
                <div className="mt-16 grid gap-8 md:grid-cols-3 max-w-6xl mx-auto px-6">
                    <div id='delivery' className="p-6 border border-[#F57C00] rounded-lg shadow-lg bg-[#F57C00] text-white">
